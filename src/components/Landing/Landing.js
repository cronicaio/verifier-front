...
class Landing extends Component {
    ...
    render() {
        const { documents, documentId, error, isLoading, translateX, hideCookies } = this.state;

        return (<div className="land" >
            <div className="land__welcome" >
                <header className="land__header" >
                    <svg onClick={this.openMobileMenu} className="land__burger-menu" xmlns="http://www.w3.org/2000/svg" width="20"
                    ...
                    <svg className="land__logo" xmlns="http://www.w3.org/2000/svg" width="148" height="36" viewBox="0 0 148 36" >
                        <g fill="none"
                            ...
                            <text fill="#FFF" fontFamily="MuseoSansCyrl" fontSize="28" fontWeight="700" letterSpacing=".133" transform="translate(0 -3)" >
                                <tspan x="50"
                                    y="29" > cronica </tspan> </text> <path fill="#FFF"
                                        fillRule="nonzero"
                        ...
                        </g> </svg> <svg className="land__logo-mobile"
                        ...
                        <nav className="land__nav" >
                            <li className="land__nav-item" >
                                <a className="land__nav-link land__nav-link_active"
                                    href="#" > home </a> </li> <li className="land__nav-item" >
                                <a className="land__nav-link"
                                    href="#" > project </a> </li> <li className="land__nav-item" >
                                <a className="land__nav-link"
                                    href="https://docs.cronica.io/"
                                    target="_blank" > developers </a> </li> <li className="land__nav-item" >
                                <a className="land__nav-link"
                                    href="#" > contacts </a> </li> </nav> </div> </header> {
                    !!documents && typeof documents === 'object' && documents.constructor === Array && documents.map((document, i) => (<Verify key={i}
                        document={document}
                        onBackClick={this.handlBackClick}
                    />
                    ))
                } {
                    !!documents && typeof documents === 'object' && documents.constructor !== Array && (<Verify document={documents}
                        onBackClick={this.handlBackClick}
                    />
                    )
                } {
                    !documents && < Fragment >
                        <div className="land__verify" >
                            <h2 className="land__verify-title" > Document Verification </h2> <form onSubmit={this.onSubmit}
                                className="land__verify-form" >
                                <label className="land__verify-label" >
                                    Instant document verification </label> <input
                                ...
                                /> <    div className="land__verify-footer" >
                                    <div className="land__verify-text" >
                                        <span > Or choose </span> <button
                                            className="land__verify-file-upload linkButton"
                                            type="button"
                                            onClick={this.onButtonLoadClick} >
                                            Document Certificate JSON </button> <input className="land__verify-file-input"
                                                id="input-file"
                                                onChange={this.onFileUpload}
                                                type="file" />
                                        <span > file </span> </div> <button className="land__verify-submit button"
                                            type="submit"
                                            disabled={isLoading} > {isLoading && < i className="fa fa-spinner fa-spin" />} {!isLoading && 'Verify'} </button> </div> {
                                    error && < div className="land__verify-error" > {error} </div>} </form> </div> <        div className="land__arrow-scroll" />
                    </Fragment>} </div> {
                !documents && < Fragment >
                    <div className="land__features" >
                        <h2 className="land__features-title" > Platform Features </h2> <ul className="land__features-list" >
                            <li className="land__features-item" >
                                ...
                                <div className="land__features-item-text" > Quorum blockchain </div> </li> <li className="land__features-item" >
                                <div className="land__features-item-icon" >
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="84"
                                        height="84"
                            ...
                            <li className="land__features-item" >
                                <div className="land__features-item-icon" >
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        </g> </svg> </div> <div className="land__features-item-text" > Security </div> </li> <li className="land__features-item" >
                                <div className="land__features-item-icon" >
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="84"
                                        height="84"
                                        ...
                                        <g fill="none"
                                            ...
                                            <path fill="#282D32"
                                                d="M4 35.5h25V37H4z" />
                                        </g> </svg> </div> <div className="land__features-item-text" > Privacy </div> </li> <li className="land__features-item" >
                                <div className="land__features-item-icon" >
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        width="77"
                                        height="78"
                                        ...
                                        </g> </svg> </div> <div className="land__features-item-text" > API </div> </li> </ul> </div> <div className="land__first-step" >
                        <div className="land__first-step-phone-img" />
                        <div >
                            <h2 className="land__first-step-title" > The First Step </h2> <div className="land__first-step-description" >
...
tamper - proof, and shareable. </div> <a className="land__first-step-button"
                                href="#" > Discover more→ </a> </div> </div> <div className="land__get" >
                        <div className="land__get-steps" >
                            ...
                            <div className="land__get-steps-wrapper" >
                                <div className="land__get-step land__get-step_1" >
                                    <h3 className="land__get-step-title" > Get the free Cronica app </h3> <div className="land__get-step-description" >
                                        The solution relies on a Quorum blockchain setup that fulfils basic requirements
                                        for the system
</div> </div> <div className="land__get-step land__get-step_2" >
                                    <h3 className="land__get-step-title" > Create an account </h3> <div className="land__get-step-description" >
                                        Document Certificate Recipients are the person or organizations in address of which certificate was issued </div> </div> <div className="land__get-step land__get-step_3" >
                                    <h3 className="land__get-step-title" > Issue document certificates </h3> <div className="land__get-step-description" >
                                        Document ID is generated by system when Certificate is recorded on a blockchain </div> </div> </div>
                            ...
                            <div className="land__get-steps-carousel-wrapper" >
                                <button className="button-carousel"
                                    ...
                                    </svg> </button> <div className="land__get-steps-carousel" >
                                    <div className="land__get-step-carousel land__get-step-carousel_1"
                                        ...
                                        <h3 className="land__get-step-title" > Get the free Cronica app </h3> <div className="land__get-step-description" >
                                            The solution relies on a Quorum blockchain setup that fulfils basic requirements
                                            for the system
</div> </div> <div className="land__get-step-carousel land__get-step-carousel_2"
                                        id="carousel-2"
                                        style={
                                            { transform: `translateX(${translateX}%)` }} >
                                        <h3 className="land__get-step-title" > Create an account </h3> <div className="land__get-step-description" >
                                            Document Certificate Recipients are the person or organizations in address of which certificate was issued </div> </div> <div className="land__get-step-carousel land__get-step-car0usel_3"
                                                id="carousel-3"
                                                style={
                                                    { transform: `translateX(${translateX}%)` }} >
                                        <h3 className="land__get-step-title" > Issue document certificates </h3> <div className="land__get-step-description" >
                                            Document ID is generated by system when Certificate is recorded on a blockchain </div> </div> </div> <button className="button-carousel"
                                                id="button-next"
                                    ...
                                    </svg> </button> </div> </div> <div className="land__get-apps" >
                            <h3 className="land__get-apps-title" > Get the Free App </h3> <div className="land__get-apps-wrapper badges" >
                                <div className="badge" >
                                    ...
                                    <div className="badge__description" >
                                        <div className="badge__hint" >
                                            Download on the </div> <div className="badge__name" >
                                            App Store </div> </div> </div> <div className="badge" >
                                    ...
                                    <div className="badge__description" >
                                        <div className="badge__hint" >
                                            GET IN ON </div> <div className="badge__name" >
                                            Google Play </div> </div> </div> </div> </div> </div> <svg className="land__support"
                                                xmlns="http://www.w3.org/2000/svg"
                    ...
                    <svg className="land__footer-logo"
                        ...
                        <g fill="none"
                            ...
                            <path stroke="#FFF"
                                strokeWidth="4"
                                d="M34.956 5.485l-16.97 16.97L9.5 13.972" />
                        </g> </svg> <div className="land__footer-header-aside" >
                        <nav className="land__nav" >
                            <li className="land__nav-item" >
                                <a className="land__nav-link land__nav-link_active"
                                    href="#" > home </a> </li> <li className="land__nav-item" >
                                <a className="land__nav-link"
                                    href="#" > project </a> </li> <li className="land__nav-item" >
                                <a className="land__nav-link"
                                    href="#" > company </a> </li> <li className="land__nav-item" >
                                <a className="land__nav-link"
                                    href="#" > contacts </a> </li> </nav> </div> </header> <div className="land__copyright" >
                    <span> The Open standard
for Blockchain Certificates </span> <span> ©CRONICA INC.2019 </span> </div>
                {!hideCookies && <div className="land__cookies">
                    <p>
                        <span>
                        ...
                        <a className="btn btn-lg btn-primary" onClick={this.onCookiesClick} >Got it</a>
                    </p>
                </div>
                }
            </footer>
            ...
            <div className={
                ...
                <div className="land__menu-header_mobile" >
                    ...
                    </svg> <svg className="land__logo-mobile"
                        xmlns="http://www.w3.org/2000/svg"
                        width="23"
                        height="23" >
                        <g fill="none"
                            ...
                            <path stroke="#76D6FF"
                                strokeWidth="3.077"
                                d="M21.511 4.222L11.068 14.665 5.846 9.443" />
                        </g> </svg> </div> <ul className="land__menu-nav_mobile" >
                    <li onClick={this.closeMobileMenu}
                        className="land__menu-item_mobile land__menu-item_mobile-active" > HOME </li> <li onClick={this.closeMobileMenu}
                            className="land__menu-item_mobile" > PROJECT </li> <li onClick={this.closeMobileMenu}
                                className="land__menu-item_mobile" >
                        <a className="land__nav-link"
                            href="https://docs.cronica.io/"
                            target="_blank" > DEVELOPERS </a>  </li> <li onClick={this.closeMobileMenu}
                                className="land__menu-item_mobile" > CONTACTS </li> </ul> </div> </div>
        )
    }
