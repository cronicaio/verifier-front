...
class Verify extends Component {
    ...
    render() {
            ...
            const { documentId, recipientName, issuerName, issueTimestamp, expireTimestamp, documentLink } = document;
            ...
            return ( <
                ...
                <
                svg className = "verify__header-icon"
                ...
                /div> <
                /div> { /*<button className="button button_alt">↓ Download Document</button>*/ } <
                /div> {
                    documentLink && ( <
                        a href = { documentLink }
...

                {
                    ...
                    {
                        isBackButton && < button className = "button button_alt-second"
                        onClick = { onBackClick } > ←Verify Another Document < /button> } <
                            /div>
                    );
                }
